...
{if !empty($display_header)}{include file="{$module_folder}fragmentosenriquecidosmanu/views/templates/front/rich-snippets-default-bootstrap-header.tpl" HOOK_HEADER=$HOOK_HEADER}{/if}
